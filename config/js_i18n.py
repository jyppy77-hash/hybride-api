...
_LABELS: dict[str, dict[str, str]] = {
    "fr": {
        ...
        "meta_partner_label": "PARTENAIRE",
        "meta_partner_text": "est propuls\u00e9 par nos partenaires",
        ...
        "chatbot_error_empty": "\U0001f916 R\u00e9ponse indisponible.",
        "chatbot_error_connection": "\U0001f916 Connexion interrompue. R\u00e9essaie dans quelques secondes !",
        "chatbot_rating_question": "Tu kiffes HYBRIDE EuroMillions ? Note ton exp\u00e9rience !",
        "chatbot_rating_low": "Bof",
        "chatbot_rating_high": "Top !",
        "chatbot_rating_5": "Merci ! Tu es un vrai !",
        "chatbot_rating_4": "Merci ! Content que \u00e7a te plaise !",
        "chatbot_rating_3": "Merci ! On va s\u2019am\u00e9liorer !",
        "chatbot_rating_2": "Merci pour ton retour !",
        "chatbot_rating_1": "Merci ! Dis-nous ce qu\u2019on peut am\u00e9liorer !",
        "chatbot_rating_default": "Merci !",
        "chatbot_rating_done": "Merci pour ton avis !",
        ...
        "rating_comment_positive": "Un commentaire ? (optionnel)",
        "rating_comment_negative": "Qu'est-ce qu'on pourrait am\u00e9liorer ? (optionnel)",
        "rating_comment_counter": "{n} / 500",

        # ── contact ──
        "contact_title": "Nous contacter",
        "contact_nom": "Votre nom (optionnel)",
        "contact_email": "Votre email (optionnel)",
        "contact_sujet": "Sujet",
        ...
        "contact_message_min": "Minimum 10 caract\u00e8res",
        "contact_counter": "{n} / 2000",
        "contact_submit": "Envoyer",
        "contact_success": "Message envoy\u00e9, merci !",
        "contact_error": "Erreur, veuillez r\u00e9essayer",
        "contact_chatbot_link": "Un souci ? Contactez-nous \u2192",
        "contact_footer_link": "Nous contacter",
    },
    ...
    "en": {
        ...
        "meta_partner_label": "PARTNER",
        "meta_partner_text": "is powered by our partners",
        ...
        "chatbot_error_empty": "\U0001f916 Response unavailable.",
        "chatbot_error_connection": "\U0001f916 Connection interrupted. Try again in a few seconds!",
        "chatbot_rating_question": "Enjoying HYBRIDE EuroMillions? Rate your experience!",
        "chatbot_rating_low": "Meh",
        "chatbot_rating_high": "Great!",
        "chatbot_rating_5": "Thanks! You\u2019re awesome!",
        "chatbot_rating_4": "Thanks! Glad you like it!",
        "chatbot_rating_3": "Thanks! We\u2019ll keep improving!",
        "chatbot_rating_2": "Thanks for your feedback!",
        "chatbot_rating_1": "Thanks! Tell us how we can improve!",
        "chatbot_rating_default": "Thanks!",
        "chatbot_rating_done": "Thanks for your feedback!",
        ...
        "rating_submit": "Send",
        "rating_comment_positive": "Any feedback? (optional)",
        "rating_comment_negative": "What could we improve? (optional)",
        "rating_comment_counter": "{n} / 500",

        # ── contact ──
        "contact_title": "Contact us",
        "contact_nom": "Your name (optional)",
        ...
        "contact_message_min": "Minimum 10 characters",
        "contact_counter": "{n} / 2000",
        "contact_submit": "Send",
        "contact_success": "Message sent, thank you!",
        "contact_error": "Error, please try again",
        "contact_chatbot_link": "Having trouble? Contact us \u2192",
        "contact_footer_link": "Contact us",
    },
    ...
    "es": {
        ...
        "meta_partner_label": "SOCIO",
        "meta_partner_text": "está impulsado por nuestros socios",
        ...
        "chatbot_error_empty": "\U0001f916 Respuesta no disponible.",
        "chatbot_error_connection": "\U0001f916 Conexi\u00f3n interrumpida. \u00a1Vuelve a intentarlo en unos segundos!",
        "chatbot_rating_question": "\u00bfTe gusta HYBRIDE EuroMillions? \u00a1Puntúa tu experiencia!",
        "chatbot_rating_low": "Regular",
        "chatbot_rating_high": "\u00a1Genial!",
        "chatbot_rating_5": "\u00a1Gracias! \u00a1Eres genial!",
        "chatbot_rating_4": "\u00a1Gracias! \u00a1Nos alegra que te guste!",
        "chatbot_rating_3": "\u00a1Gracias! \u00a1Seguiremos mejorando!",
        "chatbot_rating_2": "\u00a1Gracias por tu opini\u00f3n!",
        "chatbot_rating_1": "\u00a1Gracias! \u00a1Cu\u00e9ntanos c\u00f3mo mejorar!",
        "chatbot_rating_default": "\u00a1Gracias!",
        "chatbot_rating_done": "\u00a1Gracias por tu opini\u00f3n!",
        ...
        "rating_comment_positive": "\u00bfAlg\u00fan comentario? (opcional)",
        "rating_comment_negative": "\u00bfQu\u00e9 podr\u00edamos mejorar? (opcional)",
        "rating_comment_counter": "{n} / 500",

        # ── contact ──
        "contact_title": "Cont\u00e1ctanos",
        "contact_nom": "Tu nombre (opcional)",
        "contact_email": "Tu email (opcional)",
        "contact_sujet": "Asunto",
        "contact_sujet_bug": "Reportar un error",
        "contact_sujet_suggestion": "Sugerencia",
        "contact_sujet_question": "Pregunta",
        "contact_sujet_autre": "Otro",
        "contact_message": "Tu mensaje",
        "contact_message_min": "M\u00ednimo 10 caracteres",
        "contact_counter": "{n} / 2000",
        "contact_submit": "Enviar",
        "contact_success": "\u00a1Mensaje enviado, gracias!",
        "contact_error": "Error, int\u00e9ntalo de nuevo",
        "contact_chatbot_link": "\u00bfAlg\u00fan problema? Cont\u00e1ctanos \u2192",
        "contact_footer_link": "Cont\u00e1ctanos",
    },
    ...
    "pt": {
        ...
        "meta_partner_label": "PARCEIRO",
        "meta_partner_text": "é impulsionado pelos nossos parceiros",
        ...
        "chatbot_send_label": "Enviar",
        "chatbot_error_empty": "\U0001f916 Resposta indispon\u00edvel.",
        "chatbot_error_connection": "\U0001f916 Liga\u00e7\u00e3o interrompida. Tenta novamente dentro de alguns segundos!",
        "chatbot_rating_question": "Gostas do HYBRIDE EuroMillions? Avalia a tua experi\u00eancia!",
        "chatbot_rating_low": "Assim-assim",
        "chatbot_rating_high": "Top!",
        "chatbot_rating_5": "Obrigado! \u00c9s o maior!",
        "chatbot_rating_4": "Obrigado! Ainda bem que gostas!",
        "chatbot_rating_3": "Obrigado! Vamos melhorar!",
        "chatbot_rating_2": "Obrigado pela tua opini\u00e3o!",
        "chatbot_rating_1": "Obrigado! Diz-nos como melhorar!",
        "chatbot_rating_default": "Obrigado!",
        "chatbot_rating_done": "Obrigado pela tua opini\u00e3o!",
        ...
        "rating_submit": "Enviar",
        "rating_comment_positive": "Algum coment\u00e1rio? (opcional)",
        "rating_comment_negative": "O que podemos melhorar? (opcional)",
        "rating_comment_counter": "{n} / 500",

        # ── contact ──
        "contact_title": "Contactar-nos",
        "contact_nom": "O teu nome (opcional)",
        "contact_email": "O teu email (opcional)",
        "contact_sujet": "Assunto",
        "contact_sujet_bug": "Reportar um erro",
        "contact_sujet_suggestion": "Sugest\u00e3o",
        "contact_sujet_question": "Pergunta",
        "contact_sujet_autre": "Outro",
        "contact_message": "A tua mensagem",
        "contact_message_min": "M\u00ednimo 10 caracteres",
        "contact_counter": "{n} / 2000",
        "contact_submit": "Enviar",
        "contact_success": "Mensagem enviada, obrigado!",
        "contact_error": "Erro, tenta novamente",
        "contact_chatbot_link": "Algum problema? Contacta-nos \u2192",
        "contact_footer_link": "Contactar-nos",
    },
    ...
    "de": {
        ...
        "meta_partner_label": "PARTNER",
        "meta_partner_text": "wird von unseren Partnern unterstützt",
        ...
        "chatbot_error_empty": "\U0001f916 Antwort nicht verf\u00fcgbar.",
        "chatbot_error_connection": "\U0001f916 Verbindung unterbrochen. Versuche es in einigen Sekunden erneut!",
        "chatbot_rating_question": "Gef\u00e4llt dir HYBRIDE EuroMillions? Bewerte deine Erfahrung!",
        "chatbot_rating_low": "Naja",
        "chatbot_rating_high": "Super!",
        "chatbot_rating_5": "Danke! Du bist klasse!",
        "chatbot_rating_4": "Danke! Freut uns, dass es dir gef\u00e4llt!",
        "chatbot_rating_3": "Danke! Wir werden uns verbessern!",
        "chatbot_rating_2": "Danke f\u00fcr dein Feedback!",
        "chatbot_rating_1": "Danke! Sag uns, wie wir uns verbessern k\u00f6nnen!",
        "chatbot_rating_default": "Danke!",
        "chatbot_rating_done": "Danke f\u00fcr deine Bewertung!",
        ...
        "rating_comment_positive": "Ein Kommentar? (optional)",
        "rating_comment_negative": "Was k\u00f6nnten wir verbessern? (optional)",
        "rating_comment_counter": "{n} / 500",

        # ── contact ──
        "contact_title": "Kontakt",
        "contact_nom": "Dein Name (optional)",
        "contact_email": "Deine E-Mail (optional)",
        ...
        "contact_message_min": "Mindestens 10 Zeichen",
        "contact_counter": "{n} / 2000",
        "contact_submit": "Absenden",
        "contact_success": "Nachricht gesendet, danke!",
        "contact_error": "Fehler, bitte erneut versuchen",
        "contact_chatbot_link": "Ein Problem? Kontaktiere uns \u2192",
        "contact_footer_link": "Kontakt",
    },
    ...
    "nl": {
        ...
        "meta_partner_label": "PARTNER",
        "meta_partner_text": "wordt ondersteund door onze partners",
        ...
        "chatbot_error_empty": "\U0001f916 Antwoord niet beschikbaar.",
        "chatbot_error_connection": "\U0001f916 Verbinding onderbroken. Probeer het over enkele seconden opnieuw!",
        "chatbot_rating_question": "Vind je HYBRIDE EuroMillions leuk? Beoordeel je ervaring!",
        "chatbot_rating_low": "Matig",
        "chatbot_rating_high": "Top!",
        "chatbot_rating_5": "Bedankt! Je bent geweldig!",
        "chatbot_rating_4": "Bedankt! Fijn dat het je bevalt!",
        "chatbot_rating_3": "Bedankt! We blijven verbeteren!",
        "chatbot_rating_2": "Bedankt voor je feedback!",
        "chatbot_rating_1": "Bedankt! Vertel ons hoe we kunnen verbeteren!",
        "chatbot_rating_default": "Bedankt!",
        "chatbot_rating_done": "Bedankt voor je beoordeling!",
        ...
        "rating_comment_positive": "Een opmerking? (optioneel)",
        "rating_comment_negative": "Wat kunnen we verbeteren? (optioneel)",
        "rating_comment_counter": "{n} / 500",

        # ── contact ──
        "contact_title": "Contact opnemen",
        "contact_nom": "Uw naam (optioneel)",
        "contact_email": "Uw e-mail (optioneel)",
        "contact_sujet": "Onderwerp",
        "contact_sujet_bug": "Bug melden",
        "contact_sujet_suggestion": "Suggestie",
        "contact_sujet_question": "Vraag",
        "contact_sujet_autre": "Overig",
        "contact_message": "Uw bericht",
        "contact_message_min": "Minimaal 10 tekens",
        "contact_counter": "{n} / 2000",
        "contact_submit": "Verzenden",
        "contact_success": "Bericht verzonden, bedankt!",
        "contact_error": "Fout, probeer het opnieuw",
        "contact_chatbot_link": "Een probleem? Neem contact op \u2192",
        "contact_footer_link": "Contact opnemen",
    },
}
