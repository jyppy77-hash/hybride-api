...
_HERO_TEXTS = {
    "pt": {
        ...
        "historique": ("Histórico de Sorteios EuroMillions",
        ...
        "a_propos": ("Sobre a LotoIA EuroMillions",
    ...
    "es": {
        ...
        "historique": ("Historial de Sorteos EuroMillions",
        ...
        "a_propos": ("Acerca de LotoIA EuroMillions",
    ...
    "de": {
        ...
        "historique": ("EuroMillions Ziehungsverlauf",
        ...
        "a_propos": ("Über LotoIA EuroMillions",
    ...
    "nl": {
        ...
        "historique": ("EuroMillions Trekkingsgeschiedenis",
        ...
        "a_propos": ("Over LotoIA EuroMillions",
