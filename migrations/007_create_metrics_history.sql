...
-- Complexité : 🟢
-- Data loss potentielle : partielle (reconstructible partiellement via snapshots live)
-- PITR requis : non
-- ============================================================
-- -- ÉTAPE 1 : vérifier volume (snapshot toutes les 5 min via metrics_snapshot_lock)
-- SELECT COUNT(*) FROM metrics_history;
--
-- -- ÉTAPE 2 : drop
-- DROP TABLE IF EXISTS metrics_history;
-- -- Note : rend /admin/monitoring graphiques historiques inopérants,
-- -- mais /admin/monitoring en direct continue via get_gcp_metrics() en live.
