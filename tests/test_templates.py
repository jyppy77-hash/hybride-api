...
_PAGE_CONFIGS = [
    ...
    ("em/generateur.html", "generateur", {"body_class": "loto-page em-page", "include_nav_scroll": True, "show_disclaimer_link": True, "hero_icon": "⭐", "hero_title": "Exploration de grilles EuroMillions", "hero_subtitle": "Analyse", "sponsor75_js": "/ui/static/sponsor-popup75-em.js?v=11", "sponsor_js": "/ui/static/em/sponsor-popup-em.js?v=8", "app_js": "/ui/static/app-em.js?v=9"}),
