...
(function () {
    ...
    onReady(function () {
        ...
        function showContactLink() {
            ...
            a.href = '#';
            a.textContent = LI.contact_chatbot_link || 'Un souci ? Contactez-nous \u2192';
        ...
        function submitChatRatingEm(rating) {
            ...
            showRatingCommentSectionEm(rating);
        }

        function showRatingCommentSectionEm(rating) {
            // V141 A.4 UX Fix 1 — popup 3 tiers (low 1-2 obligatoire / mid 3 / high 4-5 optionnel)
            var widget = document.getElementById('hybride-rating-widget-em');
            if (!widget) return;
            ...
            if (isMandatory) {
                ...
                dismissBtn.addEventListener('click', function () { dismissRatingCommentEm(); });
            ...
            submitBtn.addEventListener('click', function () {
                ...
                _sendRatingPayloadEm(rating, comment.substring(0, 500));
            });
        ...
        function dismissRatingCommentEm() {
            ...
            if (window.LotoIA_track) LotoIA_track('rating-dismissed-popup', {module: 'euromillions'});
        }

        function _sendRatingPayloadEm(rating, comment) {
            ...
            if (window.LotoIA_track) LotoIA_track('rating-submitted', {rating: rating, module: 'euromillions', has_comment: hasComment});
        }
